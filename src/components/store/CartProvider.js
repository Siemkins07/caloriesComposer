...
const cartReducer = (state, action) => {
  if (action.type === "ADD") {
    const updatedTotalCalories =
      state.totalCalories + action.item.calories * action.item.amount;
  ...
  if (action.type === "REMOVE") {
    ...
    const updatedTotalCalories = state.totalCalories - existingItem.calories;
    let updatedItems;
...
const CartProvider = (props) => {
  ...
  const cartContext = {
    ...
    totalCalories: cartState.totalCalories,
